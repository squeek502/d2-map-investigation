		...
		if(hKernel32)
		{
			...
			if(lpLoadLibraryW)
			{
				...
				if(lpRemoteString)
				{
					...
					printf("WARNING: this maphack will only work with Diablo II client version 1.13C or 1.13D!\n");
					printf("You appear to have a different client version, or something else went wrong. To learn how to downgrade your\n");
